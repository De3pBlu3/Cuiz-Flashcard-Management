...
public class playLoop {
    public static void main(String[] args) {
        ...
        // so for now, we will create user_id var and assign it a temp value// we will also assume the player has chosen a game mode, and will run a different method depdning on the game mode
